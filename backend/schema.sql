...
CREATE TABLE investment_assets (
    ...
    deposit_amount DECIMAL(15,2) NOT NULL DEFAULT 0 COMMENT '납입 원금',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE pension_assets (
    ...
    current_value DECIMAL(15,2) NOT NULL DEFAULT 0 COMMENT '평가금액',
    deposit_amount DECIMAL(15,2) NOT NULL DEFAULT 0 COMMENT '납입잔액',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE daily_expenses (
    ...
    total_amount DECIMAL(10,2) NOT NULL DEFAULT 0 COMMENT '총 금액',
    food_cost DECIMAL(10,2) DEFAULT 0 COMMENT '식비',
    necessities_cost DECIMAL(10,2) DEFAULT 0 COMMENT '생필품비',
    transportation_cost DECIMAL(10,2) DEFAULT 0 COMMENT '교통비',
    other_cost DECIMAL(10,2) DEFAULT 0 COMMENT '기타',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    deleted_at TIMESTAMP NULL,
...
CREATE TABLE fixed_expenses (
    ...
    payment_date INT NOT NULL COMMENT '매월 결제일 (1-31)',
